...
class AsertoIdpSeed < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "https://github.com/aserto-dev/aserto-idp-seed/releases/download/v0.0.8/aserto-idp-seed_0.0.8_darwin_x86_64.zip", :using => GitDownloadStrategy
    sha256 "0d1a066c254c74c44d47fdc6db7d25e1aaf4ced38c74e947c83009541a12087e"
  end
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/aserto-dev/aserto-idp-seed/releases/download/v0.0.8/aserto-idp-seed_0.0.8_linux_x86_64.zip", :using => GitDownloadStrategy
